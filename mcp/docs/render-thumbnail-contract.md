...
Status: P25.4 descriptor contract; P25.24 MCP/CLI renderer-service dry-run
...
`render-thumbnail-renderer-service-fixtures.json` for the P25.24 future
...
audit plus health/no-op contract fixtures.
