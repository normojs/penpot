...
Status: P25.4 descriptor contract; P25.25 MCP/CLI renderer-service dry-run
...
plus no-op service host scaffold defined; runtime execution still blocked.
...
`render-thumbnail-renderer-service-fixtures.json` for the P25.25 future
...
audit plus health/no-op contract fixtures and no-op service host scaffold.
