...
Status: P25.4 descriptor contract; P25.23 MCP/CLI renderer-service dry-run
...
checklist plus implementation slice audit defined; runtime execution still
blocked.
...
`render-thumbnail-renderer-service-fixtures.json` for the P25.23 future
