...
- prototype/export: `prototype.create_overlay` and
  ...
  disabled dispatch adapter boundary metadata, and P25.16 opt-in configuration
  surfaces while runtime execution remains unavailable
