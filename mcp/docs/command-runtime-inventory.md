...
- prototype/export: `prototype.create_overlay` and
  ...
  P25.14 disabled health preflight plus execution harness metadata, and P25.15
  disabled dispatch adapter boundary metadata while runtime execution remains
  unavailable
