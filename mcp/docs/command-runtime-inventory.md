...
- prototype/export: `prototype.create_overlay` and
  ...
  P25.26 host lifecycle test fixtures, and P25.27 package manifest scaffold
  metadata while runtime execution remains
  unavailable
