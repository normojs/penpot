...
- prototype/export: `prototype.create_overlay` and
  ...
  harness, and P25.19 dispatch registration preflight while runtime execution
  remains unavailable
