...
- prototype/export: `prototype.create_overlay` and
  ...
  surfaces, P25.17 unavailable error taxonomy, and P25.18 integration fixture
  harness while runtime execution remains unavailable
