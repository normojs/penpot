...
- prototype/export: `prototype.create_overlay` and
  ...
  adapter registration scaffold, P25.21 adapter registry manifest, and P25.22
  enablement checklist while runtime execution remains unavailable
