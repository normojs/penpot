...
- prototype/export: `prototype.create_overlay` and
  ...
  harness, P25.19 dispatch registration preflight, and P25.20 disabled
  executable adapter registration scaffold while runtime execution remains
  unavailable
