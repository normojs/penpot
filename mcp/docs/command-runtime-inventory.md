...
- prototype/export: `prototype.create_overlay` and
  ...
  health/no-op contract fixtures, P25.25 no-op service host scaffold, and
  P25.26 host lifecycle test fixtures while runtime execution remains
  unavailable
