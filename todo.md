...
mutation, scripts, process startup, and dispatch disabled. P25.29 is the next
task: plan renderer-service package file templates.
...
| P25.29 | pending | Plan renderer-service package file templates | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define the planned contents for future package files as metadata-only templates without creating the package directory |
