...
output, and runtime dispatch disabled. P25.71 is the next task: plan
renderer-service package materialization approval audit countersignature
...
| P25.71 | todo | Plan renderer-service package materialization approval audit countersignature revocation appeal resolution enforcement evidence attestation notarization certification policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Pending | Define future audit countersignature revocation appeal resolution enforcement evidence attestation notarization certification metadata without certifying notarizations, reading audit records, materializing files, starting processes, or enabling dispatch |
