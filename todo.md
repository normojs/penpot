...
runtime dispatch disabled. P25.41 is the next task: plan renderer-service
package materialization explicit approval token.
...
| P25.41 | pending | Plan renderer-service package materialization explicit approval token | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define a future explicit approval token contract without accepting or granting approval |
