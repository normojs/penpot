...
materialization, process startup, file writes, command execution, build output,
and runtime dispatch disabled. P25.66 is the next task: plan renderer-service
...
| P25.66 | todo | Plan renderer-service package materialization approval audit countersignature revocation appeal resolution policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Pending | Define future audit countersignature revocation appeal resolution metadata without resolving appeals, reading audit records, materializing files, starting processes, or enabling dispatch |
