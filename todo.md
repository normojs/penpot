...
renderer-service package materialization approval audit trail.
...
| P25.42 | pending | Plan renderer-service package materialization approval audit trail | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future approval audit trail metadata without writing audit records or granting approval |
