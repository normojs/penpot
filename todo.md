...
| P25.46 | pending | Plan renderer-service package materialization approval scope binding policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future approval token scope binding metadata without hashing live files, validating tokens, or granting approval |
