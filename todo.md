...
a process or registering command-runtime execution. P25.26 is the next task:
plan renderer-service host lifecycle tests.
...
4. Export/file, thumbnail, component, token, or debug tool waves can supersede
   ...
   P25.25 adds a no-op service host scaffold. Remaining work: plan host
   lifecycle tests before implementing executable `render.thumbnail`.
...
| P25.26 | pending | Plan renderer-service host lifecycle tests | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define disabled host lifecycle test fixtures for start/stop/readiness/supervision without starting the renderer-service |
