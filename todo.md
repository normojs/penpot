...
making scripts runnable. P25.31 is the next task: plan renderer-service package
build verification.
...
| P25.31 | pending | Plan renderer-service package build verification | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define metadata-only build/test verification commands required before materializing package wiring |
