...
| P25.37 | pending | Plan renderer-service package materialization write contract | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define the exact write contract for future approved materialization without performing writes |
