...
process startup, file writes, command execution, build output, and runtime
dispatch disabled. P25.61 is the next task: plan renderer-service package
materialization approval audit endorsement policy.
...
| P25.61 | pending | Plan renderer-service package materialization approval audit endorsement policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit endorsement metadata without endorsing certifications, storing endorsement records, materializing files, starting processes, or enabling dispatch |
