...
| P25.74 | todo | Plan renderer-service package materialization approval audit countersignature revocation appeal resolution enforcement evidence attestation notarization certification endorsement countersignature verification policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit countersignature revocation appeal resolution enforcement evidence attestation notarization certification endorsement countersignature verification metadata without verifying countersignatures, reading audit records, materializing files, starting processes, or enabling dispatch |
