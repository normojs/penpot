...
| P25.35 | pending | Plan renderer-service package materialization approval gate | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define the explicit approval gate required before package file materialization |
