...
task: plan renderer-service package materialization execution dry-run.
...
| P25.36 | pending | Plan renderer-service package materialization execution dry-run | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define the future dry-run execution payload for approved package materialization without performing filesystem writes |
