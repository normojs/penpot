...
materialization approval emergency stop policy.
...
| P25.48 | pending | Plan renderer-service package materialization approval emergency stop policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future emergency stop metadata without fetching stop state, granting approval, materializing files, or enabling dispatch |
