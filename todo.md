...
renderer-service package materialization approval revocation policy.
...
| P25.45 | pending | Plan renderer-service package materialization approval revocation policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future approval token revocation metadata without checking revocation state, validating tokens, or granting approval |
