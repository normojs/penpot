...
mutating workspace files, or making scripts runnable. P25.28 is the next task:
plan renderer-service package creation guardrails.
...
| P25.28 | pending | Plan renderer-service package creation guardrails | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define the checks required before creating the real package directory, workspace entries, lockfile changes, and runnable scripts |
