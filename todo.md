...
renderer-service package materialization rollback contract.
...
| P25.38 | pending | Plan renderer-service package materialization rollback contract | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define rollback phases and failure recovery metadata for future approved materialization without performing writes |
