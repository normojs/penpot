...
| P25.59 | pending | Plan renderer-service package materialization approval audit notarization policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit notarization metadata without notarizing attestations, storing notarization records, materializing files, starting processes, or enabling dispatch |
