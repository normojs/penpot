...
| P25.40 | pending | Plan renderer-service package materialization final approval checklist | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define the final pre-materialization approval checklist without granting approval or performing writes |
