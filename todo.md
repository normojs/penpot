...
P25.27 is the next task: plan the renderer-service package manifest scaffold.
...
| P25.27 | pending | Plan renderer-service package manifest scaffold | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define package/workspace manifest metadata for the future renderer-service without adding the actual package or runnable scripts |
