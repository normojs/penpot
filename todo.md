...
signing/hash, materialization, process startup, file writes, command execution,
build output, and runtime dispatch disabled. P25.68 is the next task: plan
...
| P25.68 | todo | Plan renderer-service package materialization approval audit countersignature revocation appeal resolution enforcement evidence policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Pending | Define future audit countersignature revocation appeal resolution enforcement evidence metadata without collecting evidence, reading audit records, materializing files, starting processes, or enabling dispatch |
