...
| P25.47 | pending | Plan renderer-service package materialization approval operator confirmation policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future operator confirmation metadata without prompting, storing confirmation, validating tokens, or granting approval |
