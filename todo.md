...
execution, build output, and runtime dispatch disabled. P25.65 is the next
task: plan renderer-service package materialization approval audit
...
| P25.65 | pending | Plan renderer-service package materialization approval audit countersignature revocation appeal policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit countersignature revocation appeal metadata without appealing revocations, reading audit records, materializing files, starting processes, or enabling dispatch |
