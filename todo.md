...
P25.53 is the next task: plan renderer-service package materialization
approval audit access policy.
...
| P25.53 | pending | Plan renderer-service package materialization approval audit access policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit access metadata without reading audit records, granting access, materializing files, starting processes, or enabling dispatch |
