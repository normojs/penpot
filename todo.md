...
| P25.50 | pending | Plan renderer-service package materialization approval execution handoff policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future post-approval execution handoff metadata without materializing files, starting processes, or enabling dispatch |
