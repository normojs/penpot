...
is the next task: plan renderer-service package creation dry-run summary.
...
| P25.33 | pending | Plan renderer-service package creation dry-run summary | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Summarize the future package creation dry-run payload before any filesystem materialization |
