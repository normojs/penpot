...
materialization, process startup, file writes, command execution, build output,
and runtime dispatch disabled. P25.56 is the next task: plan renderer-service
package materialization approval audit custody policy.
...
| P25.56 | pending | Plan renderer-service package materialization approval audit custody policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit custody metadata without taking custody, transferring custody, materializing files, starting processes, or enabling dispatch |
