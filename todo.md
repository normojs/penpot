...
dispatch disabled. P25.54 is the next task: plan renderer-service package
materialization approval audit integrity policy.
...
| P25.54 | pending | Plan renderer-service package materialization approval audit integrity policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit integrity metadata without hashing or verifying audit records, materializing files, starting processes, or enabling dispatch |
