...
mutating workspace files, or making scripts runnable. P25.30 is the next task:
plan renderer-service package workspace wiring.
...
| P25.30 | pending | Plan renderer-service package workspace wiring | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define metadata-only planned workspace entries and root script wiring without editing workspace manifests or lockfiles |
