...
mutation disabled, command execution disabled, build output disabled, and
runtime dispatch disabled. P25.52 is the next task: plan renderer-service
package materialization approval audit retention policy.
...
| P25.52 | pending | Plan renderer-service package materialization approval audit retention policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit retention metadata without persisting audit records, materializing files, starting processes, or enabling dispatch |
