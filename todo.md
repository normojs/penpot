...
P25.22 is the next task: plan the final disabled renderer-service enablement
checklist before any executable runtime registration can be enabled.
...
4. Export/file, thumbnail, component, token, or debug tool waves can supersede
   ...
   adapter registry manifest metadata. Remaining work: plan the final disabled
   renderer-service enablement checklist before implementing executable
   `render.thumbnail`.
...
| P25.22 | pending | Plan final disabled renderer-service enablement checklist | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Pending | Summarize the remaining runtime enablement gates as metadata-only before selecting an executable renderer-service implementation task |
