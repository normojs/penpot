...
package creation file manifest.
...
| P25.34 | pending | Plan renderer-service package creation file manifest | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define the exact future package file manifest before filesystem materialization |
