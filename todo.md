...
| P25.49 | pending | Plan renderer-service package materialization approval readiness verdict policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future final readiness verdict metadata without granting approval, materializing files, or enabling dispatch |
