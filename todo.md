...
| P25.57 | pending | Plan renderer-service package materialization approval audit evidence policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit evidence metadata without collecting evidence, storing evidence, materializing files, starting processes, or enabling dispatch |
