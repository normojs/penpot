...
execution, build output, and runtime dispatch disabled. P25.58 is the next
task: plan renderer-service package materialization approval audit attestation
policy.
...
| P25.58 | pending | Plan renderer-service package materialization approval audit attestation policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit attestation metadata without attesting evidence, storing attestations, materializing files, starting processes, or enabling dispatch |
