...
plan renderer-service package materialization verification manifest.
...
| P25.39 | pending | Plan renderer-service package materialization verification manifest | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define the post-materialization verification manifest for future approved materialization without running commands or writing files |
