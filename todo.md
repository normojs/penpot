...
P25.63 is the next task: plan renderer-service package materialization approval
audit countersignature verification policy.
...
| P25.63 | pending | Plan renderer-service package materialization approval audit countersignature verification policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit countersignature verification metadata without verifying countersignatures, reading audit records, materializing files, starting processes, or enabling dispatch |
