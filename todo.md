...
command execution, build output, and runtime dispatch disabled. P25.60 is the
...
| P25.60 | pending | Plan renderer-service package materialization approval audit certification policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit certification metadata without certifying notarizations, storing certification records, materializing files, starting processes, or enabling dispatch |
