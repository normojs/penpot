...
and runtime dispatch disabled. P25.55 is the next task: plan renderer-service
package materialization approval audit provenance policy.
...
| P25.55 | pending | Plan renderer-service package materialization approval audit provenance policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit provenance metadata without tracing provenance, materializing files, starting processes, or enabling dispatch |
