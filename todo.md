...
| P25.44 | pending | Plan renderer-service package materialization approval expiry policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future approval token expiry metadata without validating tokens or granting approval |
