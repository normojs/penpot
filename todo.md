...
renderer-service package materialization approval replay guard.
...
| P25.43 | pending | Plan renderer-service package materialization approval replay guard | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future replay-prevention metadata without accepting tokens or granting approval |
