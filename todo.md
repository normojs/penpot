...
| P25.64 | pending | Plan renderer-service package materialization approval audit countersignature revocation policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Not started | Define future audit countersignature revocation metadata without revoking countersignatures, reading audit records, materializing files, starting processes, or enabling dispatch |
