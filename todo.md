...
disabled. P25.69 is the next task: plan renderer-service package
materialization approval audit countersignature revocation appeal resolution
enforcement evidence attestation policy.
...
| P25.69 | todo | Plan renderer-service package materialization approval audit countersignature revocation appeal resolution enforcement evidence attestation policy | `mcp`, `penpot-cli`, `command-runtime`, `mcp/docs`, `todo.md` | Pending | Define future audit countersignature revocation appeal resolution enforcement evidence attestation metadata without attesting evidence, reading audit records, materializing files, starting processes, or enabling dispatch |
